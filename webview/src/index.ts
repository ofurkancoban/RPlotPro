...
export { aspectRatio, computePlotDimensions, computeExportCanvas, paletteScale, computeSplitCanvas, computeGridLayout } from './geometry';
export type { Aspect, PlotDimensions, ExportOpts, ExportCanvas, Box, SplitCanvas, GridLayout } from './geometry';
...
export { dataAtPixel, formatInspectValue, panelPixelRect, pixelAtData, nearestPoint } from './inspect';
